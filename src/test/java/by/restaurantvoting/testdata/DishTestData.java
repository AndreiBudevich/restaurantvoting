...
public class DishTestData {
    ...
    static {
        ...
        dish1.setMenus(Set.of(restaurant0Menu0));
        dish2.setMenus(Set.of(restaurant0Menu1));
        dish3.setMenus(Set.of(restaurant0Menu1));
        dish4.setMenus(Set.of(restaurant0Menu1));
        dish5.setMenus(Set.of(restaurant1Menu0, restaurant1Menu1));
        dish6.setMenus(Set.of(restaurant1Menu0));
        dish7.setMenus(Set.of(restaurant1Menu0));
        dish8.setMenus(Set.of(restaurant1Menu1));
        dish9.setMenus(Set.of(restaurant1Menu1));
        dish10.setMenus(Set.of(restaurant1Menu1));
        dish11.setMenus(Set.of(restaurant1Menu1));
        dish12.setMenus(Set.of(restaurant1Menu1));
    }
}
